let predict = function (index) {
    document.querySelector('#predict-index').value = index;
    if (!!index) {
...
documentReady(function () {
    ...
    document.querySelector('#predict-button').addEventListener('click', function () {
        predict(document.querySelector('#predict-index').value);
    });
    
    document.querySelector('#random-predict-button').addEventListener('click', function () {
        predict(Math.floor(Math.random() * (28000)));
    })
});
